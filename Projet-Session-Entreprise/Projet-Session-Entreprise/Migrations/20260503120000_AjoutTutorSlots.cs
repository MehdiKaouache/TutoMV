...
namespace Projet_Session_Entreprise.Migrations
{
    public partial class AjoutTutorSlots : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TutorSlots_Tutors_TutorId",
                        column: x => x.TutorId,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "NumberOfRatings", table: "Tutors");
            migrationBuilder.DropColumn(name: "TotalRatings", table: "Tutors");
        }
    }
}
