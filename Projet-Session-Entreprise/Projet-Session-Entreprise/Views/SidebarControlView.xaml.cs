...
namespace Projet_Session_Entreprise.UI.Views
{
    public partial class SidebarControlView : UserControl
    {
        ...
        {
            var user = CurrentSessionService.CurrentUser;
            if (user != null) MainView.Instance.NavigateTo(new ProfileView(user));
        }
        ...
        private void btnSettings_Click(object sender, RoutedEventArgs e) => MainView.Instance.NavigateTo(new SettingsView());
